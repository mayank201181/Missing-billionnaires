...
export const preservationMandate: Topic = {
  ...
  guide: [
    ...
    },
    {
      ...
      whyItWorks:
        "Compound growth ≈ arithmetic average return − half the variance of returns. The +40%/−20% strategy has a 10% average but ±30% swings: variance 0.09, drag ≈ 4.5%, leaving ~5.8% — matching sqrt(1.4 × 0.8) ≈ 1.058 exactly computed. Cutting volatility raises the growth rate you actually experience even at the same average return, which is why consistency is not a style preference but arithmetic.",
